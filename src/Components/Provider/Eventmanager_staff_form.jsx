...
const Eventmanager_staff_form = (props) => {
            ...
            >
                ...
                <Modal.Body className='register-modal-body' style={{
                    ...
                    <div className="mb-1">
                        ...
                        <input type="text" className="form-control" name='name' id="name" value={formData.name} onChange={handleStaffChange} />
                    ...
                    <div className="mb-1">
                        ...
                        <input type="email" className="form-control" name='email' id="email" value={formData.email} onChange={handleStaffChange} />
                    ...
                    <div className="mb-1">
                        ...
                        <input type="text" className="form-control" name='mobile_no' id="mobile_no" value={formData.mobile_no} onChange={handleStaffChange} />
                    ...
                    <div className="mb-1">
                        ...
                        {/* <input type="text" className="form-control" name='lastname' id="lastname" value={formData.lastname} onChange={handleStaffChange} />
                        {errors.lastname && <span className='text-danger'>{errors.lastname[0]}</span>} */}
                        <select name="type" id="type" className="form-control" value={formData.type} onChange={handleStaffChange} >
                            <option value=""></option>
                    ...
                    <div className="mb-1">
                        ...
                        <input type="password" className="form-control" name='password' id="password" value={formData.password} onChange={handleStaffChange} />
                    ...
                    <div className="mb-1">
                        ...
                        <input type="text" className="form-control" name='adhaarcard_details' id="adhaarcard_details" value={formData.adhaarcard_details} onChange={handleStaffChange} />
                        {errors.adhaarcard_details && <span className='text-danger'>{errors.adhaarcard_details[0]}</span>}
                    </div>
                    <div className="mb-1">
                        <label htmlFor="skills" className="form-label">Skills:</label>
                        <input type="text" className="form-control" name='skills' id="skills" value={formData.skills} onChange={handleStaffChange} />
                    ...
                    <div className="mb-1">
                        ...
                        <input type="text" className="form-control" name='salary' id="salary" value={formData.salary} onChange={handleStaffChange} />
                    ...
                    <div className="mb-1">
                        ...
                        {/* <input type="text" className="form-control" name='lastname' id="lastname" value={formData.lastname} onChange={handleStaffChange} />
                        {errors.lastname && <span className='text-danger'>{errors.lastname[0]}</span>} */}
                        <select name="status" id="status" className="form-control" value={formData.status} onChange={handleStaffChange} >
                            <option value=""></option>
...
export default withSwal(Eventmanager_staff_form);
