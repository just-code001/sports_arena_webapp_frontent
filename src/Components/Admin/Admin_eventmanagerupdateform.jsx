...
const Admin_eventmanagerupdateform = (props) => {
                ...
                <Modal.Body className='register-modal-body' style={{
                    ...
                    <Form>
                        <div className="mb-1">
                            ...
                            <input type="text" className="form-control" name='name' id="name" value={updateFormData.name} onChange={handleChange} />
                        ...
                        <div className="mb-1">
                            ...
                            <input type="email" className="form-control" name='email' id="email" value={updateFormData.email} onChange={handleChange} />
                        ...
                        <div className="mb-1">
                            ...
                            <input type="text" className="form-control" name='mobile_no' id="mobile_no" value={updateFormData.mobile_no} onChange={handleChange} />
                        ...
                        <div className="mb-1">
                            ...
                            {/* <input type="text" className="form-control" name='lastname' id="lastname" value={updateFormData.lastname} onChange={handleChange} />
                        // {errors.lastname && <span className='text-danger'>{errors.lastname[0]}</span>} */}
                            <select name="type" id="type" className="form-control" value={updateFormData.type} onChange={handleChange} >
                                <option value=""></option>
                        ...
                        <div className="mb-1">
                            ...
                            <input type="text" className="form-control" name='adhaarcard_details' id="adhaarcard_details" value={updateFormData.adhaarcard_details} onChange={handleChange} />
                            {errors.adhaarcard_details && <span className='text-danger'>{errors.adhaarcard_details[0]}</span>}
                        </div>
                        <div className="mb-1">
                            <label htmlFor="skills" className="form-label">Skills:</label>
                            <input type="text" className="form-control" name='skills' id="skills" value={updateFormData.skills} onChange={handleChange} />
                        ...
                        <div className="mb-1">
                            ...
                            <input type="text" className="form-control" name='salary' id="salary" value={updateFormData.salary} onChange={handleChange} />
                        ...
                        <div className="mb-1">
                            ...
                            {/* <input type="text" className="form-control" name='lastname' id="lastname" value={updateFormData.lastname} onChange={handleChange} />
                        {errors.lastname && <span className='text-danger'>{errors.lastname[0]}</span>} */}
                            <select name="status" id="status" className="form-control" value={updateFormData.status} onChange={handleChange} >
                                <option value=""></option>
                        ...
                        <div className="mt-3">
                            <button name='btnAddUser' id='btnAddUser' className='btn btn-outline-dark' onClick={(event)=>handleUpdateUser(updateFormData.user_id,event)}>Update</button>
                        </div>
                    </Form>
                </Modal.Body>
                <Modal.Footer>
...
export default withSwal(Admin_eventmanagerupdateform)
